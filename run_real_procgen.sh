...
python3.8 /vol/bitbucket/${USER}/train-procgen-pytorch/train.py --exp_name coinrun --env_name coinrun --num_levels 500 --start_level 0 --distribution_mode hard --param_name hard-500-$1 --num_timesteps 2000000000 --num_checkpoints 200 --seed 6033 --random_percent 0 --use_wandb --real_procgen --device gpu
