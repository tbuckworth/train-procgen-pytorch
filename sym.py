...
# from common.espl import get_sym_arch
...
def get_sym_arch(index):
    ...
    try:
        ...
        raise NotImplementedError(f"Only {len(op_list)} architectures have been specified. {index} is out of bounds.")
...
def init_op_list(index):
    ...
    return op_index_list, op_list, op_in_list, op_inall_list
...
def printsymbolic(constw, constb, num_inputs, arch_index):
    op_index_list, op_list, op_in_list, op_inall_list = init_op_list(arch_index)
