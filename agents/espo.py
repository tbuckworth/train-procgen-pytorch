...
class ESPO(BaseAgent):
    def __init__(self,
                 ...
                 espl_loss_coef=1.,
                 **kwargs):
        super(ESPO, self).__init__(env, policy, logger, storage, device,
                                  n_checkpoints, env_valid, storage_valid)

        self.espl_loss_coef = espl_loss_coef
    ...
    def optimize(self):
        ...
        self.policy.train()
        self.policy.set_mode(1) # learning_mode
