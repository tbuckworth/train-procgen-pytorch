...
raise NotImplementedError("Lunar Lander Pre Vec Not Implemented")
...
class LunarLander(PreVecEnv):
    ...
    * The angular velocity is in units of 0.4 radians per second. In order to convert to radians per second, the value needs to be multiplied by a factor of 2.5.
    ...
    def __init__(
        ...
        super().__init__(n_envs, n_actions, "LunarLander", max_steps, render_mode)
